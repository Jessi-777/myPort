      ...
      <div className="relative z-10 py-20 px-6">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-gray-300 leading-relaxed">
            Built <span className="text-[#a9d0de] font-bold">Full-Stack SaaS Platforms </span>  and <span className="text-[#a9d0de] font-bold"> HTML, CSS, Javascript Projects </span> designed to scale, connect APIs seamlessly, and deliver smooth, intuitive user experiences.Crafted with precision, creativity, and performance in mind.
          </p>
        </div>
